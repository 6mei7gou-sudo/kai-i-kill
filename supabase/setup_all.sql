...
ALTER TABLE character_sheets ADD COLUMN IF NOT EXISTS fanart_policy JSONB DEFAULT '{}'::JSONB;
...
CREATE TABLE IF NOT EXISTS serial_codes (
  ...
  achievement_type TEXT NOT NULL DEFAULT 'special' CHECK (achievement_type IN ('mission','adv','special','levelup','dispatch')),
...
CREATE TABLE IF NOT EXISTS character_achievements (
  ...
  achievement_id TEXT NOT NULL,
  achievement_name TEXT NOT NULL,
  achievement_type TEXT NOT NULL CHECK (achievement_type IN ('mission','adv','special','levelup','dispatch')),
  source_id TEXT,
...
CREATE TABLE IF NOT EXISTS sns_posts (
  ...
  layer TEXT NOT NULL DEFAULT 'surface' CHECK (layer IN ('surface', 'hunter', 'meta', 'rp')),
...
CREATE TABLE IF NOT EXISTS sns_chat_rooms (
  ...
  mission_id TEXT,
  layer TEXT NOT NULL DEFAULT 'hunter' CHECK (layer IN ('surface', 'hunter', 'meta', 'rp')),
