...
export const CYBERNETICS = {
    ...
    'I': [
        ...
        { name: '皮下センサーアレイ', part: '胴体', cp: 1, effect: '怪異接近時に自動警告。視野+1（感知）', resonance: '浄化+1', maker: '蒼鉄機工' },
    ...
    'II': [
        ...
        { name: 'サーマルアイ', part: '眼球', cp: 3, effect: '暗視。壁越し生体感知。視野+1', resonance: '渇望+1', maker: '雷禽重工' },
    ...
    'III': [
        ...
        { name: '怪異核インプラント', part: '頭部', cp: 6, effect: '視野+1ランク。ルール直感感知', resonance: '渇望+3・恐怖+1', maker: '蜃気楼工廠' },
