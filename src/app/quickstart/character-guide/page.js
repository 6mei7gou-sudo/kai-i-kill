                    ...
                    <table>
                        ...
                        <tbody>
                            {[
                                ...
                                ['7', '侵食率80%以上で開始', '物語が始まる前に終わっている。侵食の恐怖を味わう余地がない'],
                                ['8', '元禊士の脱走兵', '「元禊士」の知識と人脈がゲームバランスを壊す'],
                                ['9', '全装身型・戦闘用搭乗型で開始', '一般の討伐者には持ちえない'],
                                ['10', 'サイバネティクス等級Ⅲで開始', '全身改造は代償が重い。物語の末に辿り着くもの'],
                                ['11', '他PCの記憶を操作できる設定', '記憶操作はNPC権限。PCが持つとPvPの原因になる'],
                                ['12', '企業所属のキャラクター', 'PCの所属は祓部・傭兵・無所属の3つのみ。蒼鉄機工・雷禽重工等の企業社員としてのPCは作成不可。企業の装備を使う傭兵や、企業と契約関係にある討伐者は可'],
                            ].map(([n, ng, reason]) => (
                                <tr key={n}>
