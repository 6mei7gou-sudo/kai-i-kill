                ...
                <div className="content-body" style={{ marginBottom: 'var(--space-lg)' }}>
                    <table>
                        ...
                        <tbody>
                            ...
                            <Row cells={['裏社会から這い上がった無所属', '底澱のスラムで育った路地裏の犬', '何も持たないが生き延びてきた']} />
                            ...
                            <Row cells={['異能に目覚めた一般人', '実験の被験者だった。逃げ出してきた', '力はあるが制御が不安定。怪異に近い自分への恐怖']} />
                ...
                <div className="content-body" style={{ marginBottom: 'var(--space-lg)' }}>
                    <table>
                        ...
                        <tbody>
                            ...
                            <Row cells={['自分自身への恐怖', '異能を持つ自分が怪異に近い。制御するために戦う']} />
                        </tbody>
                    </table>
                </div>
