...
const CHAPTERS = [
    ...
    },
    {
        ...
        desc: '討伐免許制度、祓部・傭兵・無所属の三勢力、覚醒パターン、素養と権力構造。',
        icon: '⛊',
        sections: ['10. 討伐免許制度', '11. 三種の討伐者', '12. 覚醒パターン', '13. 素養と社会構造', '14. 魔導具産業と権力構造', '15. 謎の組織について'],
    },
    {
        slug: 'guide',
        title: 'プレイヤーへの手引き',
        ...
        icon: '▶',
        sections: ['16. キャラクター作成の指針', '17. この世界で生き延びるための原則'],
    },
];
