...
const CHAPTERS = [
    ...
    { slug: 'factions', title: '組織と社会', titleEn: 'FACTIONS & SOCIETY', sections: ['10. 討伐免許制度', '11. 三種の討伐者', '12. 覚醒パターン', '13. 素養と社会構造', '14. 魔導具産業と権力構造', '15. 怪異への対応をめぐる思想', '16. 稀人（まれびと）とは', '17. 謎の組織について'] },
    { slug: 'guide', title: 'プレイヤーへの手引き', titleEn: 'PLAYER GUIDANCE', sections: ['18. キャラクター作成の指針', '19. この世界で生き延びるための原則'] },
];
