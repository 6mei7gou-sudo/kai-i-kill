...
// KAI-I//KILL キャラクターシート — マスターデータ
// sheet-app/data.js から移行、ESM形式に変換
...
export const RANKS = Object.keys(RANK_DATA);
...
export const AWAKENING_PATTERNS = [
    '事故遭遇型', '実験被験者型', '呪詛継承型',
...
export const INITIAL_STATE = {
    ...
    emotions: Object.fromEntries(EMOTIONS.map(e => [e.id, 0])),
    erosion: 0,
    equipped: [],
    selectedGifts: [],
    notes: '',
