...
- **【用語名】** — 分類・関連語・解説
- ★マークは討伐者の間で広く共有されている重要用語
- ？マークは情報が不完全または真偽不明の用語
...
- **P（基礎言語）**：全魔法の土台で魔導具製造の基幹
- **Igniscript（赤）**：燃やす・爆発させる方向で力任せに直線的なアプローチ
- **Lupis Surf（青）**：流す・包む方向で柔軟に攻防両用
- **Ivyo（緑）**：育てる・自然のサイクルに乗せる方向で持続性がある
- **NGT（黄）**：加速・電気的処理の方向でデジタルインフラと親和性が高い
- **Monyx（無色）**：最小限の術式で組む方向で汎用性が最も高く魔導具調整に多用
- **P:（紫）**：Pの派生で弱体化・妨害・封印の方向に特化し習得者が少ない
- **P'（桃）**：Pの別派生で回復・強化・修復の方向に特化し使用者への身体的負荷が大きい
