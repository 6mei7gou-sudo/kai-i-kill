...
異世界出身の人間、もしくはそれに類似した知的生命体に対する呼称だ。出身世界の文明レベルは原則として現世と同等もしくはそれ以下に限られる。およそ人間と呼べるシルエットだが特異な外見的特徴（身体の一部の萎縮や肥大化、他生物に類似した形質など）を持つことがある。多くのケースで言語的コミュニケーションが成立する。他言語を用いる場合でも現世の翻訳技術により円滑な意思疎通が取れるものとする。
...
- **分類**：思想
- **関連**：怪異排除主義、技術部、封印班、傭兵

怪異を新たな資源や道具とみなし、管理や研究によって、かつての魔法のように人間社会に取り入れようという考え方だ。技術部や封印班の中にはこうした思想を持つ者が少なくない。また、傭兵の間で報酬のために不当に依頼を発生させるといった行為もこれに該当する。
...
法律で原則禁止されている魔法が存在する。透明化魔法は暗殺・犯罪への悪用リスクが高く基本禁止だ。召喚魔法は怪異の発生原理と酷似しており怪異誘発リスクが非常に高いため禁止されている。
...
討伐者が能力に目覚めたパターンの分類だ。四種がある。先天覚醒型は生まれつき素養を持ち訓練で開花させた人間で祓部に多い。ショック覚醒型は怪異に関わる強烈な体験が引き金で恨みが動機に直結しやすく精神的なダメージを抱えやすい。実験覚醒型は何者かの人体実験で強制覚醒させられた人間で素養強度が高い代わりに代償が大きい。接触覚醒型は怪異の核や特殊な素材への長期接触で覚醒するパターンで汚染リスクが伴う。
...
南管区（第三管区）に広がる孤立した群島だ。本土との交通手段が限られ情報伝達が遅い。島ごとに数百〜数千人が暮らし、本土のようにSNSの噂からではなく古い島の伝承から怪異が発生する独自の怪異生態系を持つ。各島には祓部の系統とは独立した怪異対処者「島守」がいるとされ、祓部への協力度は島によって異なる。「地図から消えた島」があるという噂が討伐者の間で語られている。
...
西管区に本店を構える店舗だ。五管区地図には錆ヶ浜の北方に本店の位置が記されているが、業態や来歴は討伐者の間でも詳しく知られていない。傭兵の街として知られる錆ヶ浜の近郊にあることから傭兵との関わりが噂されているが真偽は不明だ。
